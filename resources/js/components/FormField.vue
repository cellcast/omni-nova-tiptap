  ...
  >
    <template #field>
      <div style="position: relative; top: 0; left: 0">
        <div
          class="w-full overflow-break bg-gray-100 rounded"
          ...
          <div class="p-1">
            ...
            >
              ...
              <template v-else-if="button == 'rtl'">
                <rtl-button :editor="editor" :mode="mode"> </rtl-button>
              </template>
        ...
        <div
          class="nova-tiptap-editor form-input form-input-bordered w-full pt-2 pb-2 mt-3"
          :style="cssProps"
          v-show="mode == 'editor'"
        >
        ...
        <div class="mt-3 w-full px-0" v-show="mode == 'html'">
