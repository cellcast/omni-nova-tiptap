      ...
      <div class="px-8 py-8 bg-white">
        ...
        <div style="padding-top: 32px">
          ...
          <div class="grid grid-cols-2 gap-3 mt-3">
            ...
            <div class="flex mt-3">
              <label
                class="text-sm mb-1 ml-1 mr-3"
                v-text="ttt('AV required')"
              ></label>
              <input
                type="checkbox"
                v-model="avRequired"
  ...
  methods: {
    showImageMenu() {
      if (this.imageIsActive) {
        ...
        this.linkUrl = attributes["tt-link-url"]
          ? attributes["tt-link-url"]
          : "";
        this.avRequired = attributes["av-required"];
      } else {
        this.url = "";
        ...
        .then(
          function (response) {
            ...
            let attributes = {
              ...
              "av-required": this.avRequired ? "true" : "false",
            };
